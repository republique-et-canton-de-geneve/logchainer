...
public class FolderServiceImpl implements FolderService{
	...
	Files.copy(Paths.get(pathTmp + "/" + pathFile), Paths.get(pathOutput + "/" + pathFile), StandardCopyOption.REPLACE_EXISTING);
	
	LOG.info("file successfully moved to directory : " + pathOutput + "/" + pathFile + ", replacing file if one with same name was already existing");
